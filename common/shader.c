...
void shader_set_uniform_4_float(shader s, const char *name, float f0, float f1, float f2, float f3)
{
    struct shader_context *ctx = s;
    ...
    glUniform4f(glGetUniformLocation(ctx->program, name), f0, f1, f2, f3);
}